                    ...
                    <form class="cours-search">
                        <div class="input-group">
                            <input type="search" wire:model.debounce.500ms="search" class="form-control"
                                ...
                                placeholder="Kata kunci pencarian album ...">
            ...
            <div class="row">
                <div class="col-lg-9 col-md-8 col-12">
                    @if ($albums->count())
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="flexbox align-items-center mt-3">
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ route('album.detail', $item->slug) }}">Selengkapnya</a>
                        ...
                        @endforeach
                    @else
                        <h2>Album belum tersedia atau kata kunci tidak ditemukan</h2>
                    @endif


                    <div aria-label="Page navigation example">
                        {{ $albums->links('vendor.livewire.bootstrap') }}
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="side-block px-20 py-10 bg-white">
                        ...
                        <div class="widget">
                            <h4 class="pb-15 mb-25 bb-1">Recent albums </h4>
