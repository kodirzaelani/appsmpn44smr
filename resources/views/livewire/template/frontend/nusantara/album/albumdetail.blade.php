                    ...
                    <div class="blog-post mb-30">
                        <div class="blog-detail popup-vdo">
                            ...
                            <div class="entry-meta ">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#"><i class="fa fa-user"></i> {{ $album->author->name }}</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-calendar-o"></i>
                                            {{ TanggalID('j M Y', $album->created_at) }}</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-eye"></i> {{ $album->view_count }} Kali</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="entry-image clearfix position-relative">
                            <img class="img-fluid px-30"
                                src="{{ $album->imageUrl ? $album->imageUrl : '/assets/images/no_image.png' }}"
                                alt="">
                        </div>
