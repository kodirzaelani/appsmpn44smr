<div>
            ...
            <div class="row mt-30">
                <div class="col-12">
                    <div class="owl-carousel owl-theme owl-btn-1" data-nav-arrow="false" data-nav-dots="false"
                        ...
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-1.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-2.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-3.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-4.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-5.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-6.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-7.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-8.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-9.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-10.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-11.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                        <div class="item"><img src="{{ asset('') }}assets/images/unilogo/uni-12.jpg"
                                class="img-fluid my-15 rounded box-shadowed pull-up" alt=""></div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-50 bg-img countnm-bx"
        style="background-image: url({{ asset('') }}assets/images/background/bg-3.jpeg)" data-overlay="5"
        data-aos="fade-up">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
