<div>
    ...
    <section class="py-50 bg-white" data-aos="fade-up">
        <div class="container">
            ...
            <div class="row mt-30">
                <div class="col-12">
                    <div class="owl-carousel owl-theme owl-btn-1" data-nav-arrow="true" data-nav-dots="true"
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="entry-meta mb-10">
                                        <ul class="list-unstyled">
                                            ...
                                            <li><a href="#"><i class="fa fa-calendar-o"></i> 12 Aug 2020</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="entry-content">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus fuga
                                            laborum totam
                            ...
                            <div class="blog-post">
                                <div class="entry-image clearfix">
                                    <ul class="grid-post list-unstyled">
                                        <li>
                                            <img class="img-fluid"
                                                src="{{ asset('') }}assets/images/courses/5f.jpeg"
                                                alt="">
                                        </li>
                                        <li>
                                            <img class="img-fluid"
                                                src="{{ asset('') }}assets/images/courses/6f.jpeg"
                                                alt="">
                                        </li>
                                        <li>
                                            <img class="img-fluid"
                                                src="{{ asset('') }}assets/images/courses/7f.jpeg"
                                                alt="">
                                        </li>
                                        <li>
                                            <img class="img-fluid"
                                                src="{{ asset('') }}assets/images/courses/8f.jpeg"
                                                alt="">
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="entry-content">
                                        <p>
                                            ...
                                            laborum totam
                                            itaque architecto! Laudantium sed delectus assumenda, doloribus non.
                                        </p>
                                    </div>
                                    <div class="entry-share d-flex justify-content-between align-items-center">
                                        <div class="entry-button">
