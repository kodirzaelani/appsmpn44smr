                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.periode.index') }}">Periode</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="row mb-20">
                                <div class="col-12">
                                    <div class="box bs-3 border-success">
                                        ...
                                        @livewire('template.backend.nusantara.periode.periodeedit')
                                    </div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="row mb-20">
                                <div class="col-12">
                                    <div class="box bs-3 border-success">
                                        ...
                                        @livewire('template.backend.nusantara.periode.periodecreate')
                                    </div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $dataperiodeall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $dataperiodeall->total() }}</strong>?
                                ...
                                @if ($dataperiodeall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($dataperiodeall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $dataperiodeall->firstItem() }}</th>
                                                        <td>
                                                            {{ !empty($item->pergub_id) ? $item->peraturan->pergubnum : '' }}
                                                        </td>
                                                        <td>
                                                            {{ !empty($item->startdate) ? $item->startdate : '' }}
                                                            | {{ !empty($item->enddate) ? $item->enddate : '' }}
                                                        </td>
                                                        <td width="10%">
                                                            {!! $item->statuslabel !!}
                                                        </td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $dataperiodeall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $dataperiodeall->currentPage() }} | Show
                                            {{ $dataperiodeall->count() }} data of {{ $dataperiodeall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
