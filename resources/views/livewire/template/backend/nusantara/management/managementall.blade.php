                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.management.index') }}">@yield('title')</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datamanagementall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                ...
                                @if ($datamanagementall->count())
                                                ...
                                                @foreach ($datamanagementall as $no => $item)
                                                    <tr>
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datamanagementall->firstItem() }}</th>
                                                        <td width="20%">
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datamanagementall->currentPage() }} | Show
                                            {{ $datamanagementall->count() }} data of
                                            {{ $datamanagementall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
