<div>
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h3 class="page-title">Peraturan Gubernur</h3>
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.peraturan.index') }}">Peraturan Gubernur</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="row mb-20">
                                <div class="col-12">
                                    <div class="box bs-3 border-success">
                                        ...
                                        @livewire('template.backend.nusantara.pergub.pergubedit')
                                    </div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="row mb-20">
                                <div class="col-12">
                                    <div class="box bs-3 border-success">
                                        ...
                                        @livewire('template.backend.nusantara.pergub.pergubcreate')
                                    </div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $dataperguball->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $dataperguball->total() }}</strong>?
                                ...
                                @if ($dataperguball->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($dataperguball as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $dataperguball->firstItem() }}</th>
                                                        <td>
                                                            {{ !empty($item->year) ? $item->year : '' }}<br />
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $dataperguball->currentPage() }} | Show
                                            {{ $dataperguball->count() }} data of {{ $dataperguball->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
