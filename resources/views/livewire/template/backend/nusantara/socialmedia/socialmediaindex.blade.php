                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datamediasocial->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datamediasocial->total() }}</strong>?
                        ...
                        <div class="row">
                                ...
                                @if ($datamediasocial->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datamediasocial as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datamediasocial->firstItem() }}</th>

                                                        <td>
                                                            {{ !empty($item->title) ? $item->title : '' }}
                                                        </td>
                                                        <td>
                                                            <i class="fa {{ !empty($item->icon) ? $item->icon : '' }}"
                                                                aria-hidden="true"></i>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                            {{ $datamediasocial->links() }}
                                            Page : {{ $datamediasocial->currentPage() }} | Show
                                            {{ $datamediasocial->count() }}
                                            data of {{ $datamediasocial->total() }}
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                @if ($statusUpdate == true)
                                    @livewire('template.backend.nusantara.socialmedia.socialmediaedit')
                                @else
                                    @livewire('template.backend.nusantara.socialmedia.socialmediacreate')
                                @endif
                            </div>
                        </div>
                    </div>
