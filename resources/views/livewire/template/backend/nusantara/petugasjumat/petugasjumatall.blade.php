                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('backend.petugasjumat.create') }}"><i
                                    ...
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                ...
                                                <strong>{{ $datapetugasjumatall->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                                You have selected <strong>{{ count($checked) }}</strong> items, Do you
                                                want to Select All
                                                <strong>{{ $datapetugasjumatall->total() }}</strong>?
                                ...
                                @if ($datapetugasjumatall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datapetugasjumatall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datapetugasjumatall->firstItem() }}</th>
                                                        <td width="10%">
                                                        ...
                                                        <td>
                                                            {{ !empty($item->title_khotib) ? $item->title_khotib : '' }}<br />
                                                        </td>
                                                        <td>
                                                            {{ TanggalID('j M Y', $item->startdate) }}
                                                        </td>
                                                        {{-- <td width="10%">
                                                    {!! $item->statuslabel !!}
                                                </td> --}}
                                                        ...
                                                        <td class="text-center align-midle" width="10%">
                                                            ...
                                                            <a title="Edit" class="btn btn-xs btn-warning edit-row"
                                                                href="{{ route('backend.petugasjumat.edit', $item->id) }}">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datapetugasjumatall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datapetugasjumatall->currentPage() }} | Show
                                            {{ $datapetugasjumatall->count() }} data of
                                            {{ $datapetugasjumatall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
