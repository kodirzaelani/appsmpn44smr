                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datatag->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                                You have selected <strong>{{ count($checked) }}</strong> items, Do you
                                                want to Select All
                                                <strong>{{ $datatag->total() }}</strong>?
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-md-8 col-lg-8 col-12">
                                @if ($datatag->count())
                                    <div class="table-responsive">
                                        <table class="table editable-table table-hover mb-0">
                                            <tbody>
                                                <tr>
                                                ...
                                                @foreach ($datatag as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        ...
                                                        <td>
                                                            <div class="checkbox">
                                                                <input type="checkbox"
                                                                    id="Checkbox_{{ $no + $datatag->firstItem() }}"
                                                                    value="{{ $item->id }}" wire:model="checked">
                                                                <label
                                                                    for="Checkbox_{{ $no + $datatag->firstItem() }}"></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <a title="Show"
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datatag->currentPage() }} | Show {{ $datatag->count() }} data
                                            of {{ $datatag->total() }}
                                        </div>
                                    </div>
                                @else
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                @if ($statusUpdate == true)
                                    @livewire('template.backend.nusantara.post.tag.tagedit')
                                @else
                                    @livewire('template.backend.nusantara.post.tag.tagcreate')
                                @endif
                            </div>
                        </div>
                    </div>
