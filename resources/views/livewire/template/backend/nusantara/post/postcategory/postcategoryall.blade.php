<div>
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h3 class="page-title">Post Categories</h3>
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.postscategories.index') }}">All Post Categories</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datapostcategory->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datapostcategory->total() }}</strong>?
                        ...
                        <div class="row">
                                ...
                                @if ($datapostcategory->count())
                                                ...
                                                @foreach ($datapostcategory as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datapostcategory->firstItem() }}</th>
                                                        {{-- <td>
                                                    <div class="checkbox">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datapostcategory->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datapostcategory->currentPage() }} | Show
                                            {{ $datapostcategory->count() }} data of {{ $datapostcategory->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                @if ($statusUpdate == true)
                                    @livewire('template.backend.nusantara.post.postcategory.postcategoryedit')
                                @else
                                    @livewire('template.backend.nusantara.post.postcategory.postcategorycreate')
                                @endif
                            </div>
                        </div>
                    </div>
