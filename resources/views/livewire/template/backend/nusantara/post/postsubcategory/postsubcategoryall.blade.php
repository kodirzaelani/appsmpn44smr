<div>
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h3 class="page-title">Post Sub Categories</h3>
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.postscategories.index') }}">All Post Sub Categories</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                ...
                                                <strong>{{ $datapostsubcategory->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                                You have selected <strong>{{ count($checked) }}</strong> items, Do you
                                                want to Select All
                                                <strong>{{ $datapostsubcategory->total() }}</strong>?
                        ...
                        <div class="row">
                                ...
                                @if ($datapostsubcategory->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datapostsubcategory as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datapostsubcategory->firstItem() }}</th>
                                                        {{-- <td>
                                                    <div class="checkbox">
                                                        ...
                                                        <td>
                                                            @if ($item->posts->count() > 0)
                                                                <a title="Show Post"
                                                                    href="{{ route('post.subcategory', $item->postcategory->slug) }}"
                                                                    target="_blank"
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datapostsubcategory->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datapostsubcategory->currentPage() }} | Show
                                            {{ $datapostsubcategory->count() }} data of
                                            {{ $datapostsubcategory->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                @if ($statusUpdate == true)
                                    @livewire('template.backend.nusantara.post.postsubcategory.postsubcategoryedit')
                                @else
                                    @livewire('template.backend.nusantara.post.postsubcategory.postsubcategorycreate')
                                @endif
                            </div>
                        </div>
                    </div>
