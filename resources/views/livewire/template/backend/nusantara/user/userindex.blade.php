                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datauser->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                                You have selected <strong>{{ count($checked) }}</strong> items, Do you
                                                want to Select All
                                                <strong>{{ $datauser->total() }}</strong>?
                                                ...
                                                @foreach ($datauser as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datauser->firstItem() }}</th>
                                                        <td width="10%">
                                                            <img class="avatar avatar-lg rounded bg-success-light"
                                                                src="{{ $item->imageThumbUrl ? $item->imageThumbUrl : '/assets/images/avatar/avatar-4.png' }}"
                                                        ...
                                                        <td class="text-center align-midle">
                                                            @if ($item->masterstatus == config('cms.default_masteruser'))
                                                                <button class="btn btn-xs btn-success disabled"
                                                                    title="No Change"><i class="fa fa-eye"></i></button>
                                                            @else
                                                                @if ($item->status == 1)
                                                                    <button
                                                            ...
                                                            @if ($item->masterstatus == config('cms.default_masteruser'))
                                                                <button
                                                                    class="btn btn-xs btn-danger mx-1 my-1 disabled"
                                                                    title="Delete"><i
