                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.structuroganization.index') }}">@yield('title')</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                ...
                                                <strong>{{ $datastructuroganizationall->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                ...
                                @if ($datastructuroganizationall->count())
                                                ...
                                                @foreach ($datastructuroganizationall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datastructuroganizationall->firstItem() }}</th>
                                                        <td width="20%">
                                                        ...
                                                        <td>
                                                            ...
                                                            <small
                                                                class="text-primary">{{ !empty($item->title) ? $item->title : '' }}</small><br>
                                                            parent <small
                                                                class="text-primary">{{ !empty($item->parent_id) ? $item->parent_id : '' }}</small>
                                                        </td>
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            @can('structuroganization.delete')
                                                                <button
                                                                    ...
                                                                    class="btn btn-xs btn-danger" title="Edit"><i
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datastructuroganizationall->currentPage() }} | Show
                                            {{ $datastructuroganizationall->count() }} data of
                                            {{ $datastructuroganizationall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
