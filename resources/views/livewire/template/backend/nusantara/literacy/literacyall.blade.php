<div>
    {{-- @section('title', 'List of Literasi') --}}
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h3 class="page-title">Literasi</h3>
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.literacies.index') }}">Literasi</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <ul class="box-controls pull-right">
                            <li><a href="{{ route('backend.literacies.create') }}" class="btn btn-success text-white">
                                    Add </a></li>
                        </ul>
                    </div>
                    <div class="box-body">
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $dataliteracyall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $dataliteracyall->total() }}</strong>?
                                ...
                                @if ($dataliteracyall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($dataliteracyall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $dataliteracyall->firstItem() }}</th>
                                                        {{-- <td>
                                                    <div class="checkbox">
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            @if ($item->author_id == $author_id)
                                                                <a title="Edit"
                                                                    class="btn btn-xs btn-warning edit-row"
                                                                    href="{{ route('backend.literacies.edit', $item->id) }}"><i
                                                                        class="fa fa-edit"></i></a>
                                                            @else
                                                                <button title="Forbidden"
                                                                    class="btn btn-xs btn-warning edit-row" disabled><i
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $dataliteracyall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $dataliteracyall->currentPage() }} | Show
                                            {{ $dataliteracyall->count() }} data of {{ $dataliteracyall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
