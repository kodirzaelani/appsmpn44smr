<div>
    {{-- @section('title', 'List of Sub Kategori Literasi') --}}
    <!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h3 class="page-title">Sub Kategori Literasi</h3>
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.literacysubcategories.index') }}">Sub Kategori Literasi</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="box-body">
                                    ...
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                ...
                                                <strong>{{ $dataliteracysubcategoryall->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                                You have selected <strong>{{ count($checked) }}</strong> items, Do you
                                                want to Select All
                                                <strong>{{ $dataliteracysubcategoryall->total() }}</strong>?
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-md-8 col-lg-8 col-12">
                                @if ($dataliteracysubcategoryall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($dataliteracysubcategoryall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $dataliteracysubcategoryall->firstItem() }}</th>
                                                        {{-- <td>
                                                    <div class="checkbox">
                                                        ...
                                                        <td>
                                                            {{ !empty($item->literacycategory_id) ? $item->literacycategory->title : '' }}<br />
                                                            {{-- <small>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $dataliteracysubcategoryall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $dataliteracysubcategoryall->currentPage() }} | Show
                                            {{ $dataliteracysubcategoryall->count() }} data of
                                            {{ $dataliteracysubcategoryall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                @if ($statusUpdate == true)
                                    @livewire('template.backend.nusantara.literacy.literacysubcategory.literacysubcategoryedit')
                                @else
                                    @livewire('template.backend.nusantara.literacy.literacysubcategory.literacysubcategorycreate')
                                @endif
                            </div>
                        </div>
                    </div>
