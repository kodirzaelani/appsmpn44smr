        ...
        <form enctype="multipart/form-data" wire:submit.prevent="update">
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" wire:model="sort" class="form-control @error('sort') is-invalid @enderror"
                            placeholder="ID">
                    </div>
                    <div class="form-control-feedback"><small class="text-primary"> {{ $sort }}</small></div>
                    @error('sort')
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" wire:model="title"
                            class="form-control @error('title') is-invalid @enderror" placeholder="Description">
                    </div>
