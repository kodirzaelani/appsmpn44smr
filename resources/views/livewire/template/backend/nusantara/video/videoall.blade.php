                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-primary btn-xs" href="{{ route('backend.video.create') }}"><i
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datavideoall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datavideoall->total() }}</strong>?
                                ...
                                @if ($datavideoall->count())
                                                ...
                                                @foreach ($datavideoall as $no => $item)
                                                    ...
                                                    <div class="checkbox">
                                                        ...
                                                        <td>
                                                            ...
                                                            <span
                                                                class="text-success">{{ !empty($item->videocategory_id) ? $item->videocategory->title : '' }}</span>
                                                            | <span
                                                                class="text-primary">{{ TanggalID('j M Y', $item->created_at) }}</span>
                                                        </td>
                                                        {{-- <td width="10%">
                                                    {!! $item->statuslabel !!}
                                                </td> --}}
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datavideoall->currentPage() }} | Show
                                            {{ $datavideoall->count() }} data of {{ $datavideoall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
