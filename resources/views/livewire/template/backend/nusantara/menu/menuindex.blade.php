                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.menu.index') }}">All @yield('title')</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datamenucategory->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datamenucategory->total() }}</strong>?
                        ...
                        <div class="row">
                                ...
                                @if ($datamenucategory->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datamenucategory as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datamenucategory->firstItem() }}</th>
                                                        <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datamenucategory->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datamenucategory->currentPage() }} | Show
                                            {{ $datamenucategory->count() }} data of {{ $datamenucategory->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                @if ($statusUpdate == true)
                                    @livewire('template.backend.nusantara.menu.menuedit')
                                @else
                                    @livewire('template.backend.nusantara.menu.menucreate')
                                @endif
                            </div>
                        </div>
                    </div>
