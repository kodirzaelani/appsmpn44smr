                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">List Agenda</li>
                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            ...
                            <a class="btn btn-sm btn-primary" href="{{ route('backend.agendas.create') }}"><i
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $dataagendaall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $dataagendaall->total() }}</strong>?
                                ...
                                @if ($dataagendaall->count())
                                            ...
                                            <tbody>
                                                @foreach ($dataagendaall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        ...
                                                        {{-- <td>
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="Checkbox_{{ $no + $dataagendaall->firstItem() }}" value="{{ $item->id }}" wire:model="checked">
                                                        <label for="Checkbox_{{ $no + $dataagendaall->firstItem() }}"></label>
                                                    </div>
                                                </td> --}}
                                                        <td width="10%">
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $dataagendaall->currentPage() }} | Show
                                            {{ $dataagendaall->count() }} data of {{ $dataagendaall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
