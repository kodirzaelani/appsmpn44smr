                            ...
                            <div class="row mb-2">
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    <div class="box bs-3 border-success">
                                        ...
                                        @livewire('template.backend.nusantara.fservice.fserviceedit')
                                    </div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    <div class="box bs-3 border-success">
                                        ...
                                        @livewire('template.backend.nusantara.fservice.fservicecreate')
                                    </div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datafserviceall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datafserviceall->total() }}</strong>?
                                ...
                                @if ($datafserviceall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datafserviceall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datafserviceall->firstItem() }}</th>

                                                        <td width="10%">
                                                            <img class="w-80 rounded"
                                                                src="{{ $item->imageUrl ? $item->imageUrl : '/assets/images/no_image.png' }}"
                                                                alt="...">
                                                        </td>
                                                        <td>
                                                            {{ !empty($item->title) ? $item->title : '' }}
                                                        </td>
                                                        <td width="10%" class="fw-semibold text-primary">
                                                        ...
                                                        <td class="text-center align-midle" width="10%">
                                                            @if ($item->status == 1)
                                                                <button
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datafserviceall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datafserviceall->currentPage() }} | Show
                                            {{ $datafserviceall->count() }} data of {{ $datafserviceall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
