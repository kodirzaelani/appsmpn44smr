                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <ul class="box-controls pull-right">
                            <li><a href="{{ route('backend.menuitem.structure') }}" class="btn btn-primary"
                                    style="margin:0 4px; padding: 0 4px; vertical-align: middle; font-size: 0.8571rem; font-weight: 400;">Structure</a>
                            </li>|
                            {{-- <li><button  class="btn btn-primary" >List Menu Item</button></li>| --}}
                            <li><button wire:click="selectItem('', 'add')" class="btn btn-success">Add Menu
                                    Item</button></li>
                        </ul>
                    </div>
                    <div class="box-body">
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datamenuitem->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                        ...
                                        @if ($datamenuitem->count())
                                            ...
                                            <div class="mt-3 row">
                                                ...
                                                <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                                    Page : {{ $datamenuitem->currentPage() }} | Show
                                                    {{ $datamenuitem->count() }} data of {{ $datamenuitem->total() }}
                                                </div>
                                            </div>
                                        @else
                                            <hr>
                                            <h2 style="color: red" class="text-center">@yield('title') not available
                                            </h2>
                                        @endif
                                    </div>
                                </div>
