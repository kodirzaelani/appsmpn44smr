                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Foto</li>
                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('backend.fotos.create') }}"><i
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datafotoall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datafotoall->total() }}</strong>?
                                ...
                                @if ($datafotoall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datafotoall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datafotoall->firstItem() }}</th>
                                                        {{-- <td>
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="Checkbox_{{ $no + $datafotoall->firstItem() }}" value="{{ $item->id }}" wire:model="checked">
                                                        <label for="Checkbox_{{ $no + $datafotoall->firstItem() }}"></label>
                                                    </div>
                                                </td> --}}
                                                        <td width="10%">
                                                        ...
                                                        <td>
                                                            {{ !empty($item->album) ? $item->album->title : '' }}<br />
                                                        </td>
                                                        <td width="10%">
                                                            {!! $item->statuslabel !!}
                                                        </td>
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            <a title="Edit" class="btn btn-xs btn-warning edit-row"
                                                                href="{{ route('backend.fotos.edit', $item->id) }}">
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datafotoall->currentPage() }} | Show
                                            {{ $datafotoall->count() }} data of {{ $datafotoall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
