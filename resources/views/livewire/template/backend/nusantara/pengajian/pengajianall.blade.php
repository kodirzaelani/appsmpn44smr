                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Daftar Agenda</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('backend.pengajian.create') }}"><i
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datapengajianall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datapengajianall->total() }}</strong>?
                                ...
                                @if ($datapengajianall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datapengajianall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datapengajianall->firstItem() }}</th>
                                                        <td width="10%">
                                                        ...
                                                        <td>
                                                            {{ !empty($item->pengajiancategory_id) ? $item->pengajiancategories->title : '' }}<br />
                                                        </td>
                                                        <td>
                                                            {{ TanggalID('j M Y', $item->startdate) }}<br />
                                                            {{ !empty($item->periode) ? $item->periode : '' }}
                                                            {{-- {!! $item->statuslabel !!} --}}
                                                        </td>
                                                        {{-- <td>
                                                    {{ TanggalID("j M Y", $item->created_at) }}
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            <a title="Edit" class="btn btn-xs btn-warning edit-row"
                                                                href="{{ route('backend.pengajian.edit', $item->id) }}">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datapengajianall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datapengajianall->currentPage() }} | Show
                                            {{ $datapengajianall->count() }} data of {{ $datapengajianall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
