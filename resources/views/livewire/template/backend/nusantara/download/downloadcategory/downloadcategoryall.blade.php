<div>
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h3 class="page-title">Download Categories</h3>
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.download.categoryindex') }}">Download Categories</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <button wire:click="selectItemview('create')" class="btn btn-primary btn-xs"><i
                    ...
                    <div class="box-body">
                        @if ($statusUpdate == true)
                            <div class="row mb-20">
                                <div class="col-12">
                                    @livewire('template.backend.nusantara.download.downloadcategory.downloadcategoryedit')
                                    <hr>
                                </div>
                            </div>
                        @elseif ($statusView == 1)
                                ...
                                <div class="col-12">
                                    <div class="box bs-3 border-success">
                                        <div class="box-header">
                                            ...
                                            <div class="box-controls pull-right">
                                                <button wire:click="selectItemview('cancel')"
                                                    class="btn btn-info btn-sm"><i class="fa fa-undo"
                                                        aria-hidden="true"></i> Cancel</button>
                                            </div>
                                        </div>
                                        @livewire('template.backend.nusantara.download.downloadcategory.downloadcategorycreate')
                                    </div>
                                    <hr>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                ...
                                                <strong>{{ $datadownloadcategoryall->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                                You have selected <strong>{{ count($checked) }}</strong> items, Do you
                                                want to Select All
                                                <strong>{{ $datadownloadcategoryall->total() }}</strong>?
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($datadownloadcategoryall->count())
                                        ...
                                        <table class="table table-hover mb-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    @endforeach
                                                    <th scope="col" width="20%" class="text-center">Download
                                                        Count</th>
                                                    <th scope="col" width="20%" class="text-center">Action</th>
                                                </tr>
                                            </tbody>
                                            <tbody>
                                                @foreach ($datadownloadcategoryall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datadownloadcategoryall->firstItem() }}</th>
                                                        <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datadownloadcategoryall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datadownloadcategoryall->currentPage() }} | Show
                                            {{ $datadownloadcategoryall->count() }} data of
                                            {{ $datadownloadcategoryall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
