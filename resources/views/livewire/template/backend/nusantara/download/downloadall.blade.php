                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.download.downloadindex') }}">@yield('title')</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a href="{{ route('backend.download.create') }}" class="btn btn-primary btn-xs"><i
                    ...
                    <div class="box-body">
                        @if ($statusView == 1)
                            <div class="row">
                                <div class="col-12">
                                    @livewire('template.backend.nusantara.download.downloadcreate')
                                </div>
                            </div>
                        @endif
                        @if ($statusUpdate == true)
                            <div class="row">
                                <div class="col-12">
                                    @livewire('template.backend.nusantara.download.downloadedit')
                                </div>
                            </div>
                        @endif
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datadownloadall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datadownloadall->total() }}</strong>?
                                ...
                                @if ($datadownloadall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($datadownloadall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datadownloadall->firstItem() }}</th>

                                                        <td>
                                                            {{ !empty($item->title) ? $item->title : '' }}<br />
                                                        </td>
                                                        <td>
                                                            {{ !empty($item->downloadcategory_id) ? $item->downloadcategory->title : '' }}<br />
                                                        </td>
                                                        <td>
                                                            @if ($item->attach)
                                                                <span class="text-primary fw-bold">Attachment</span>
                                                            @elseif ($item->linkdownload)
                                                                <span class="text-info fw-bold">Link</span>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            <a title="Edit" class="btn btn-xs btn-warning edit-row"
                                                                href="{{ route('backend.download.edit', $item->id) }}">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $datadownloadall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datadownloadall->currentPage() }} | Show
                                            {{ $datadownloadall->count() }} data of {{ $datadownloadall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
