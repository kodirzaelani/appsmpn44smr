                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-sm btn-primary " href="{{ route('backend.organizations.create') }}"><i
                                    ...
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                ...
                                                <strong>{{ $dataorganizationall->total() }}</strong> items.
                                            </div>
                                        @else
                                            <div>
                                                You have selected <strong>{{ count($checked) }}</strong> items, Do you
                                                want to Select All
                                                <strong>{{ $dataorganizationall->total() }}</strong>?
                                ...
                                @if ($dataorganizationall->count())
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($dataorganizationall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $dataorganizationall->firstItem() }}</th>
                                                    ...
                                                    {!! $item->statuslabel !!}
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            <a title="Edit" class="btn btn-xs btn-warning edit-row"
                                                                href="{{ route('backend.organizations.edit', $item->id) }}">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $dataorganizationall->links() }}
                                        </div>
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $dataorganizationall->currentPage() }} | Show
                                            {{ $dataorganizationall->count() }} data of
                                            {{ $dataorganizationall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
