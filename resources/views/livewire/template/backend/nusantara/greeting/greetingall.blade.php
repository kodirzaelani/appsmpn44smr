                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('backend.greetings.create') }}"><i
                                ...
                                @if ($datagreetingall->count())
                                                    ...
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            <a title="Edit" class="btn btn-xs btn-warning edit-row"
                                                                href="{{ route('backend.greetings.edit', $item->id) }}">
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datagreetingall->currentPage() }} | Show
                                            {{ $datagreetingall->count() }} data of {{ $datagreetingall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
