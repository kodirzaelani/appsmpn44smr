                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datapagecategory->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                ...
                                @if ($datapagecategory->count())
                                                ...
                                                @foreach ($datapagecategory as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datapagecategory->firstItem() }}</th>
                                                        <td>
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                            Page : {{ $datapagecategory->currentPage() }} | Show
                                            {{ $datapagecategory->count() }} data of {{ $datapagecategory->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
