                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="col-md-10 mb-2">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $datapermission->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $datapermission->total() }}</strong>?
                        ...
                        <div class="row">
                                ...
                                @if ($datapermission->count())
                                                ...
                                                @foreach ($datapermission as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $datapermission->firstItem() }}</th>
                                                        <td>
                                                            <div class="checkbox">
                                                                <input type="checkbox"
                                                                    id="Checkbox_{{ $no + $datapermission->firstItem() }}"
                                                                    value="{{ $item->id }}" wire:model="checked">
                                                                <label
                                                                    for="Checkbox_{{ $no + $datapermission->firstItem() }}"></label>
                                                            </div>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                            ...
                                            Page : {{ $datapermission->currentPage() }} | Show
                                            {{ $datapermission->count() }} data of {{ $datapermission->total() }}
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                @if ($statusUpdate == true)
                                    @livewire('template.backend.nusantara.permission.permissionedit')
                                @else
                                    @livewire('template.backend.nusantara.permission.permissioncreate')
                                @endif
                            </div>
                        </div>
                    </div>
