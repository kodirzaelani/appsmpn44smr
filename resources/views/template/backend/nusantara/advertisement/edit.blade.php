...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.advertisements.index') }}">All Advertisement</a></li>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data"
            action="{{ route('backend.advertisements.update', $advertisement) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $advertisement->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="demo-radio-button">
                                    <input {{ $advertisement->position == 1 ? 'checked' : '' }} value="1"
                                        name="position" type="radio" id="radio_30" class="with-gap radio-col-success"
                                        checked />
                                    <label for="radio_30">Home Top</label>
                                    <input {{ $advertisement->position == 2 ? 'checked' : '' }} value="2"
                                        name="position" type="radio" id="radio_32" class="with-gap radio-col-success" />
                                    <label for="radio_32">Home Midle</label>
                                    <input {{ $advertisement->position == 3 ? 'checked' : '' }} value="3"
                                        name="position" type="radio" id="radio_33" class="with-gap radio-col-success" />
                                    <label for="radio_33">Home Bottom</label>
                                    <input {{ $advertisement->position == 4 ? 'checked' : '' }} value="4"
                                        name="position" type="radio" id="radio_34" class="with-gap radio-col-success" />
                                    <label for="radio_34">Sidebar Right Top</label>
                                    <input {{ $advertisement->position == 5 ? 'checked' : '' }} value="5"
                                        name="position" type="radio" id="radio_35" class="with-gap radio-col-success" />
                                    <label for="radio_35">Sidebar Right Midle</label>
                                    <input {{ $advertisement->position == 6 ? 'checked' : '' }} value="6"
                                        name="position" type="radio" id="radio_36" class="with-gap radio-col-success" />
                                    <label for="radio_36">Sidebar Right Bottom</label>
                                    <input {{ $advertisement->position == 7 ? 'checked' : '' }} value="7"
                                        name="position" type="radio" id="radio_37" class="with-gap radio-col-success" />
                                    <label for="radio_37">Sidebar Left Top</label>
                                    <input {{ $advertisement->position == 8 ? 'checked' : '' }} value="8"
                                        name="position" type="radio" id="radio_38" class="with-gap radio-col-success" />
                                    <label for="radio_38">Sidebar Left Midlle</label>
                                    <input {{ $advertisement->position == 9 ? 'checked' : '' }} value="9"
                                        name="position" type="radio" id="radio_39" class="with-gap radio-col-success" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="10" cols="80" class="form-control @error('scripthtml') is-invalid @enderror"
                                    name="scripthtml">{{ old('scripthtml') ?? $advertisement->scripthtml }}</textarea>
                                @error('scripthtml')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input id="linkimage" name="linkimage" type="text"
                                    ...
                                    placeholder="Link untuk gambar"
                                    value="{{ old('linkimage') ?? $advertisement->linkimage }}">
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $advertisement->imageThumbUrl ? $advertisement->imageThumbUrl : '/assets/images/no_image.png' }}"
                                            alt="...">
                                    </div>
