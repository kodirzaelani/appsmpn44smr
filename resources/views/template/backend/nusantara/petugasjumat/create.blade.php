...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.petugasjumat.index') }}">All Agenda</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create a Petugas Jumat</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.petugasjumat.store') }}"
            method="post">
            <div class="row">
                @csrf
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Create a Petugas Jumat
                            </h4>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title_khotib"
                                        ...
                                        value="{{ old('title_khotib') }}" placeholder="Khotib" required>
                                </div>
                                @error('title_khotib')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title_imam"
                                        ...
                                        value="{{ old('title_imam') }}" placeholder="Imam" required>
                                </div>
                                @error('title_imam')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title_muadzin"
                                        ...
                                        value="{{ old('title_muadzin') }}" placeholder="Muadzin" required>
                                </div>
                                @error('title_muadzin')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="time" name="periode"
                                        value="{{ old('periode') }}" id="example-date-input">
                                </div>
                                @error('periode')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
