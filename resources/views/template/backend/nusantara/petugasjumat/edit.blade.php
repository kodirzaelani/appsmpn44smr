...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.petugasjumat.index') }}">All petugas jumat</a></li>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data"
            action="{{ route('backend.petugasjumat.update', $petugasjumat) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $petugasjumat->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title_khotib"
                                        class="form-control @error('title_khotib') is-invalid @enderror"
                                        value="{{ old('title_khotib') ?? $petugasjumat->title_khotib }}"
                                        placeholder="Khotib" required>
                                </div>
                                @error('title_khotib')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title_imam"
                                        class="form-control @error('title_imam') is-invalid @enderror"
                                        value="{{ old('title_imam') ?? $petugasjumat->title_imam }}" placeholder="Imam"
                                        required>
                                </div>
                                @error('title_imam')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title_muadzin"
                                        class="form-control @error('title_muadzin') is-invalid @enderror"
                                        value="{{ old('title_muadzin') ?? $petugasjumat->title_muadzin }}"
                                        placeholder="Muadzin" required>
                                </div>
                                @error('title_muadzin')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor1" rows="10" cols="80" class="form-control @error('description') is-invalid @enderror"
                                    name="description">{{ old('description') ?? $petugasjumat->description }}</textarea>
                                @error('description')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input id="video" name="video" type="text"
                                    ...
                                    value="{{ old('video') ?? $petugasjumat->video }}">
                                    ...
                                    <div class="box border-0 rounded-lg shadow-sm">
                                        <div class="text-center box-body">
                                            <iframe width="560" height="315"
                                                src="https://www.youtube.com/embed/{{ $petugasjumat->video }}"
                                                frameborder="0"
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group row">
                                <label for="example-date-input" class="col-sm-4 col-form-label">Date <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="date" name="startdate"
                                        value="{{ old('startdate') ?? $petugasjumat->startdate }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="time" name="periode"
                                        value="{{ old('periode') ?? $petugasjumat->periode }}" id="example-time-input">
                                </div>
                                @error('periode')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                                ...
                                <div class="form-group">
                                    <div class=" fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                            <img src="{{ $petugasjumat->imageThumbUrl ? $petugasjumat->imageThumbUrl : '/assets/images/no_image.png' }}"
                                                alt="...">
                                        </div>
