                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.widgets.index') }}">All Widget</a></li>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="demo-radio-button in-line">
                                    <input name="position" value="10" {{ old('position') == '10' ? 'checked' : '' }}
                                        type="radio" id="radio_18"
                                        class="@error('position') is-invalid @enderror with-gap radio-col-success" />
                                    <label for="radio_18">Home Page</label>
                                    <input name="position" value="20" {{ old('position') == '20' ? 'checked' : '' }}
                                        type="radio" id="radio_19"
                                        class="@error('position') is-invalid @enderror with-gap radio-col-success" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="demo-radio-button in-line">
                                    <input value="_self" name="targetview"
                                        {{ old('targetview') == '_self' ? 'checked' : '' }} type="radio" id="radio_20"
                                        class="@error('targetview') is-invalid @enderror with-gap radio-col-success" />
                                    <label for="radio_20">Self</label>
                                    <input value="_blank" name="targetview"
                                        {{ old('targetview') == '_blank' ? 'checked' : '' }} type="radio" id="radio_21"
                                        class="@error('targetview') is-invalid @enderror with-gap radio-col-success" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="demo-radio-button in-line">
                                    <input value="1" name="typelink" {{ old('typelink') == '1' ? 'checked' : '' }}
                                        type="radio" id="radio_11"
                                        class="@error('typelink') is-invalid @enderror with-gap radio-col-primary" />
                                    <label for="radio_11">Custome Link</label>
                                    <input value="2" name="typelink" {{ old('typelink') == '2' ? 'checked' : '' }}
                                        type="radio" id="radio_12"
                                        class="@error('typelink') is-invalid @enderror with-gap radio-col-primary" />
                                    <label for="radio_12">Page </label>
                                    <input value="3" name="typelink" {{ old('typelink') == '3' ? 'checked' : '' }}
                                        type="radio" id="radio_13"
                                        class="@error('typelink') is-invalid @enderror with-gap radio-col-primary" />
