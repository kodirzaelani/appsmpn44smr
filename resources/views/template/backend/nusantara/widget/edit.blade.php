                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.agendas.index') }}">All Foto</a></li>
                                    ...
                                    <li>
                                        <div class="mailbox-attachment-info">
                                            <a href="#" class="mailbox-attachment-name"><i
                                                    class="fa fa-paperclip"></i> {{ $agenda->attach }}</a>
                                            <span class="mailbox-attachment-size">
                                                {{ $fileSize }} KB
                                                <a href="{{ url('') }}/uploads/images/agenda/{{ $agenda->attach }}"
                                                    target="_blank" class="btn btn-primary btn-xs pull-right"><i
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="time" name="periode"
                                        value="{{ old('periode') ?? $agenda->periode }}" id="example-time-input">
                                </div>
                                @error('periode')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
