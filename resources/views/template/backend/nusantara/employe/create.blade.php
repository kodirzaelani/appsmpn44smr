                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="nik" type="text" required value="{{ old('nik') }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="birth_date"
                                            value="{{ old('birth_date') }}" id="example-date-input">
                                        @error('birth_date')
                                ...
                                <div class="col-md-8 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="email" required value="{{ old('email') }}"
                                            ...
                                            placeholder="Enter a employe email">
                                        @error('email')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="family" type="text" value="{{ old('family') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input name="phonefamily" type="text" value="{{ old('phonefamily') }}"
                            ...
                            <div class="form-group @error('statusfamily') has-error @enderror">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="statusfamily">
                                    ...
                                    <option value="1" {{ old('statusfamily') == '1' ? 'selected' : '' }}>Suami
                                    </option>
                                    <option value="2" {{ old('statusfamily') == '2' ? 'selected' : '' }}>Istri
                                    </option>
                                    <option value="3" {{ old('statusfamily') == '3' ? 'selected' : '' }}>Saudara
                                    </option>
                                </select>
                                @error('statusfamily')
                                    <span class="help-block"><strong>{{ $message }}</strong></span>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="password">Password : <span
                                        class="text-danger fs-16">KaltimBerdaulat!</span></label>
                            </div>
                        </div>
