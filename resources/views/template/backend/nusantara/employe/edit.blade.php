                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('backend.employes.index') }}">Officer list</a>
                            </li>
                        ...
                        <div class="active tab-pane" id="update">
                            ...
                            <div class="box no-shadow">
                                ...
                                <form id="post-form" enctype="multipart/form-data"
                                    action="{{ route('backend.employes.update', $employe->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="example-date-input">Birth Date <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" type="date" name="birth_date"
                                                        value="{{ old('birth_date') ?? $employe->birth_date }}"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="nik" type="text" required
                                                        ...
                                                        placeholder="Enter a employe nik">
                                                    @error('nik')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="celuller_no" type="text"
                                                        ...
                                                        placeholder="Enter a Whatapps" readonly>
                                                    @error('celuller_no')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="username" type="text"
                                                        ...
                                                        placeholder="Enter a username" readonly>
                                                    @error('username')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="email" type="email" required
                                                        ...
                                                        placeholder="Enter a employe email" readonly>
                                                    @error('email')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group @error('gender') has-error @enderror">
                                                    ...
                                                    <select class="form-control select2" style="width: 100%;"
                                                        ...
                                                        <option value="L"
                                                            ...
                                                            @if ($employe->gender == 'L') selected @endif>Laki-laki
                                                        </option>
                                                        <option value="P"
                                                            {{ old('gender') == 'P' ? 'selected' : '' }}
                                                            @if ($employe->gender == 'P') selected @endif>Perempuan
                                                        </option>
                                                    </select>
                                                    @error('gender')
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group @error('agama_id') has-error @enderror">
                                                    <label class="form-label">Religi <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-control select2" style="width: 100%;"
                                                        name="agama_id">
                                                        ...
                                                        @foreach ($religions as $item)
                                                            <option value="{{ $item->agamaid }}"
                                                                {{ old('agama_id') == $item->agamaid ? 'selected' : '' }}
                                                                @if ($item->agamaid == $employe->agama_id) selected @endif>
                                                                {{ $item->nama }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('agama_id')
                                            ...
                                            <div class="col-md-3 col-12">
                                                <div
                                                    class="form-group @error('jenjangpendidikan_id') has-error @enderror">
                                                    ...
                                                    <select class="form-control select2" style="width: 100%;"
                                                        ...
                                                        @foreach ($educations as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('jenjangpendidikan_id') == $item->id ? 'selected' : '' }}
                                                                @if ($item->id == $employe->jenjangpendidikan_id) selected @endif>
                                                                {{ $item->title }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            <label for="department">Education Department <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 col-12">
                                                <div class="form-group">
                                                    <label for="family" class="mb-2">Family <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    <label for="phonefamily" class="mb-2 ">Phone Family <span
                                                            class="text-danger">*</span></label>
                                                    <input name="phonefamily" type="text"
                                                        value="{{ old('phonefamily') ?? $employe->phonefamily }}"
                                                        class="form-control @error('phonefamily') is-invalid @enderror"
                                            ...
                                            <div class="col-md-3 col-12">
                                                <div class="form-group @error('statusfamily') has-error @enderror">
                                                    <label class="form-label">Status family <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-control select2" style="width: 100%;"
                                                        name="statusfamily">
                                                        <option value="" holder>Select status</option>
                                                        <option value="1"
                                                            {{ old('statusfamily') == '1' ? 'selected' : '' }}
                                                            @if ($employe->statusfamily == '1') selected @endif>Suami
                                                        </option>
                                                        <option value="2"
                                                            {{ old('statusfamily') == '2' ? 'selected' : '' }}
                                                            @if ($employe->statusfamily == '2') selected @endif>Istri
                                                        </option>
                                                        <option value="3"
                                                            {{ old('statusfamily') == '3' ? 'selected' : '' }}
                                                            @if ($employe->statusfamily == '3') selected @endif>Saudara
                                                        </option>
                                                    </select>
                                                    @error('statusfamily')
                                                        <span class="help-block"><strong>{{ $message }}</strong></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" rows="3" cols="80" class="form-control @error('address') is-invalid @enderror"
                                                name="address">{{ old('address') ?? $employe->address }}</textarea>
                                            @error('address')
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class=" fileinput fileinput-new"
                                                                ...
                                                                <div class="fileinput-new img-thumbnail"
                                                                    style="width: 200px;">
                                                                    <img src="{{ $employe->imageThumbUrl ? $employe->imageThumbUrl : '/assets/images/no_image.png' }}"
                                                                        alt="...">
                                                                </div>
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="box">
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label class="form-label">Maps <span
                                                                    class="text-danger">*</span></label>
                                                            <textarea id="editor1" rows="7" cols="6" class="form-control @error('maps') is-invalid @enderror"
                                                                name="maps">{{ old('maps') ?? $employe->maps }}</textarea>
                                                            @error('maps')
                                                                <div class="form-control-feedback"><small>
                                                                        <code>{{ $message }}</code> </small></div>
                                                            @enderror
                ...
                <div class="box box-widget widget-user">
                    ...
                    <div class="widget-user-image">
                        ...
                        <img class="rounded-circle"
                            src="{{ $employe->imageThumbUrl ? $employe->imageThumbUrl : '/assets/images/avatar/avatar-4.png' }}"
                            alt="{{ $employe->name }}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    ...
                                    <p>Birth Date :<span
                                            class="text-gray ps-10"></span>{{ TanggalID('j M Y', $employe->birth_date) }}</span>
                                    </p>
                                    ...
                                    <p>Biografi :<span class="text-gray ps-10">
                                            <p>{{ $employe->user->bio }}</p>
                                        </span></p>
                                </div>
                            </div>
                            <div class="col-12">
