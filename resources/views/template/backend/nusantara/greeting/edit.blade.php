...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.greetings.index') }}">All Page</a></li>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.greetings.update', $greeting) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $greeting->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor1" rows="10" cols="80" class="form-control @error('content') is-invalid @enderror"
                                    name="content">{{ old('content') ?? $greeting->content }}</textarea>
                                @error('content')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input id="video" name="video" type="text"
                                    ...
                                    value="{{ old('video') ?? $greeting->video }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input class="form-control @error('published_at') is-invalid @enderror" name="published_at"
                                    type="date" value="{{ old('published_at') ?? $greeting->published_at }}"
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $greeting->imageThumbUrl ? $greeting->imageThumbUrl : '/assets/images/no_image.png' }}"
                                            alt="...">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="caption_image" id="caption_image" class="form-control @error('caption_image') is-invalid @enderror"
                                        placeholder="Caption Image">{{ old('caption_image') ?? $greeting->caption_image }}</textarea>
                                    @error('caption_image')
