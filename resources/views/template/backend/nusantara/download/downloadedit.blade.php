...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.download.downloadindex') }}">All Page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit a dowload</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.download.update', $download) }}"
            method="post">
            @csrf
            @method('PUT')
            <div class="row">
                    ...
                    <div class="box bs-3 border-success">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $download->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="urlcontent" id="urlcontent" rows="5"
                                    class="form-control  @error('urlcontent') is-invalid @enderror" placeholder="URL  Content">{{ old('urlcontent') ?? $download->urlcontent }}</textarea>
                                <small>Example :
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="linkdownload"
                                        ...
                                        value="{{ old('linkdownload') ?? $download->linkdownload }}" placeholder="ID File">
                                </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="box">
                        ...
                        <div class="box-footer text-end">
                            ...
                            <a class="btn btn-sm btn-info me-2" href="{{ route('backend.download.downloadindex') }}"><i
                                    class="fa fa-undo" aria-hidden="true"></i> Cancel</a>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group form-group-float">
                                <select name="downloadcategory_id"
                                    class="form-select @error('downloadcategory_id') is-invalid @enderror">
                                    <option value="" selected>Select Category</option>
                                    @foreach ($downloadcategories as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $download->downloadcategory_id) selected @endif>{{ $item->title }}</option>
                                    @endforeach
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <p><small>Current : {{ $download->attach }}</small></p>
                                @error('attach')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
