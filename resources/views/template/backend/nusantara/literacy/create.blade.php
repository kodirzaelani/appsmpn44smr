                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="urlcontent" id="urlcontent" rows="5"
                                    class="form-control  @error('urlcontent') is-invalid @enderror" placeholder="URL  Content">{{ old('urlcontent') }}</textarea>
                                <small>Example :
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="linkdownload"
                                        ...
                                        value="{{ old('linkdownload') }}" placeholder="ID File">
                                </div>
                        ...
                        <div class="box-body text-center">
                            <div class="form-group row">
                                ...
                                <div class="c-inputs-stacked">
                                    <input value="1" name="comment_status" type="radio" id="radio_35"
                                        class="with-gap radio-col-success" />
                                    <label for="radio_35">Active</label>
                                    <input value="0" name="comment_status" type="radio" id="radio_36"
                        ...
                        <div class="box-body text-center ">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="caption_image" id="caption_image" class="form-control @error('caption_image') is-invalid @enderror"
                                    placeholder="Caption Cover">{{ old('caption_image') }}</textarea>
                                @error('caption_image')
