...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.pengajian.index') }}">All Agenda</a></li>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.pengajian.update', $pengajian) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $pengajian->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="tema"
                                        ...
                                        value="{{ old('tema') ?? $pengajian->tema }}" placeholder="Tema">
                                </div>
                                @error('tema')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="narasumber"
                                        ...
                                        value="{{ old('narasumber') ?? $pengajian->narasumber }}" placeholder="Narasumber">
                                </div>
                                @error('narasumber')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                <h5>Cadangan Narasumber </h5>
                                <div class="controls">
                                    <input type="text" name="secondnarasumber"
                                        class="form-control @error('secondnarasumber') is-invalid @enderror"
                                        value="{{ old('secondnarasumber') ?? $pengajian->secondnarasumber }}"
                                        placeholder="Cadangan Narasumber">
                                </div>
                                @error('secondnarasumber')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="location"
                                        ...
                                        value="{{ old('location') ?? $pengajian->location }}" placeholder="Tempat">
                                </div>
                                @error('location')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor1" rows="10" cols="80" class="form-control @error('description') is-invalid @enderror"
                                    name="description">{{ old('description') ?? $pengajian->description }}</textarea>
                                @error('description')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="maps"
                                        ...
                                        value="{{ old('maps') ?? $pengajian->maps }}" placeholder="Coming soon" readonly>
                                </div>
                                @error('maps')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input id="video" name="video" type="text"
                                    ...
                                    value="{{ old('video') ?? $pengajian->video }}">
                                    ...
                                    <div class="box border-0 rounded-lg shadow-sm">
                                        <div class="text-center box-body">
                                            <iframe width="560" height="315"
                                                src="https://www.youtube.com/embed/{{ $pengajian->video }}"
                                                frameborder="0"
                        ...
                        <div class="box-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="date" name="startdate"
                                        value="{{ old('startdate') ?? $pengajian->startdate }}" id="example-date-input">
                                </div>
                                @error('startdate')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group row">
                                <label for="example-time-input" class="col-sm-4 col-form-label">Time <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="time" name="periode"
                                        value="{{ old('periode') ?? $pengajian->periode }}" id="example-time-input">
                                </div>
                                @error('periode')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <select class="form-control select2" style="width: 100%;" name="pengajiancategory_id">
                                ...
                                @foreach ($pengajiancatagories as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('pengajiancategory_id') == $item->id ? 'selected' : '' }}
                                        @if ($item->id == $pengajian->pengajiancategory_id) selected @endif>
                                        {{ $item->title }}
                                @endforeach
                            </select>
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $pengajian->imageThumbUrl ? $pengajian->imageThumbUrl : '/assets/images/no_image.png' }}"
                                            alt="...">
                                    </div>
