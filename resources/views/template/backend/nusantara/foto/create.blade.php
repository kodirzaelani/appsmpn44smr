...
@section('content')
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.fotos.store') }}" method="post">
            <div class="row">
                @csrf
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Create a Foto
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="form-group @error('album_id') has-error @enderror">
                                    <label class="form-label">Album Category <span class="text-danger">*</span></label>
                                    <select class="form-control select2" style="width: 100%;" name="album_id">
                                        <option value="" holder>Select Album Category</option>
                                        @foreach ($albums as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('album_id') == $item->id ? 'selected' : '' }}>{{ $item->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('album_id')
