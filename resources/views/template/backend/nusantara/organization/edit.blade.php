...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.organizations.index') }}">All </a></li>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data"
            action="{{ route('backend.organizations.update', $organization) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $organization->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="singkatan"
                                        ...
                                        value="{{ old('singkatan') ?? $organization->singkatan }}" placeholder="Singkatan"
                                        required>
                                </div>
                                @error('singkatan')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                ...
                                <select class="form-control select2" style="width: 100%;" name="pergub_id">
                                    ...
                                    @foreach ($pergubs as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('pergub_id') == $item->id ? 'selected' : '' }}
                                            @if ($item->id == $organization->pergub_id) selected @endif>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor1" rows="10" cols="80" class="form-control @error('description') is-invalid @enderror"
                                    name="description">{{ old('description') ?? $organization->description }}</textarea>
                                @error('description')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                                ...
                                <select class="form-control select2" style="width: 100%;" name="parent_id">
                                    ...
                                    @foreach ($strukturorganisasi as $item)
                                        <option value="{{ $item->id }}"
                                            ...
                                            @if ($item->id == $organization->parent_id) selected @endif>
                                            {{ $item->title }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="number" name="urut"
                                        ...
                                        value="{{ old('urut') ?? $organization->urut }}" placeholder="Urutan" required>
                                </div>
                                @error('urut')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $organization->imageThumbUrl ? $organization->imageThumbUrl : '/assets/images/no_image.png' }}"
                                            alt="...">
                                    </div>
                                    ...
                                    <div>
                                        <span class="btn btn-outline-secondary btn-file"><span
                                            ...
                                            <input type="file" class="@error('logo') is-invalid @enderror"
                                                name="logo" value="{{ old('logo') }}"></span>
