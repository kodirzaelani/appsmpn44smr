...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.organizations.index') }}">All Page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create a unit</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.organizations.store') }}"
            method="post">
            <div class="row">
                @csrf
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Create a Unit
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="singkatan"
                                        ...
                                        value="{{ old('singkatan') }}" placeholder="Singkatan" required>
                                </div>
                                @error('singkatan')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="urut"
                                        ...
                                        value="{{ old('urut') }}" placeholder="Urutan" required>
                                </div>
                                @error('urut')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
