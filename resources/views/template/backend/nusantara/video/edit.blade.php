...
@section('content')
                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.video.index') }}">All
                                    Video</a></li>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.video.update', $video) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $video->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                <label for="video"><i class="fa fa-youtube" aria-hidden="true"></i> Content Video <span
                                        class="text-danger"> * youtube</span></label>
                                ...
                                <select class="form-control select2" style="width: 100%;" name="videocategory_id">
                                    ...
                                    @foreach ($videocatagories as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('videocategory_id') == $item->id ? 'selected' : '' }}
                                            @if ($item->id == $video->videocategory_id) selected @endif>
                                            {{ $item->title }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $video->imageThumbUrl ? $video->imageThumbUrl : '/assets/images/no_image.png' }}"
                                            alt="...">
                                    </div>
