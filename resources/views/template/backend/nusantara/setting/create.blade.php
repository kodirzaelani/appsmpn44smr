                            ...
                            <div class="box-body">
                                ...
                                <ul class="nav nav-tabs customtab2" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#profile7"
                                            ...
                                            <span class="hidden-xs-down">Media Social</span></a> </li>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="twitter"
                                                                ...
                                                                value="{{ old('twitter') }}" placeholder="Alamat Twitter"
                                                                required>
                                                        </div>
                                                        <div class="form-control-feedback"><small><code>Alamat
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-12">
                                                    <div class="box">
                                                        ...
                                                        <div class="box-body">
                                                            <div class="form-group">
                                                                <label class="form-label">Hero Slider / Hero Static
                                                                    :</label>
                                                            ...
                                                            <div class="box" id="link_hero">
                                                                <div class="box-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="form-label">Image Hero Size : 800
                                                                            pixel x
                                                                            600
                                                                            pixel |
                                                                            1Mb</label> <br>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span class="font-italic"> Example ID Video on
                                                                            Youtube:
                                                                            DfMz1NMIVe4</span>
                                                                        @error('video_hero')
                                                                            <div class="form-control-feedback"><small>
