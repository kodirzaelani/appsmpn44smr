...
class FservicesController extends Controller
{
    ...
    {
        $this->middleware(['permission:fservices.index|fservices.create|fservices.edit|fservices.delete|fservices.trash']);
        $this->uploadPath = public_path(config('cms.image.directoryWidget'));
    }

    public function index()
    {
        return view('template.backend.nusantara.fservices.index', [
            'title' => 'Services'
        ]);
    }
    ...
    {
        return view('template.backend.nusantara.fservices.create', [
            'title'        => 'Widget',
            'typelink'     => '3',
