...
namespace App\Http\Livewire\Template\Backend\Nusantara\Album;
...
class Albumall extends Component
{
    ...
    public function photoCreated()
    {
        ...
        $this->resetErrorBag();
        $this->resetValidation();
        $this->dispatchBrowserEvent('closemodalFormAddPhotos');
    }
    ...
    public function selectItem($itemId, $action)
    {
        ...
        if ($action == 'delete') {
            ...
            // This will show the modal in the frontend
            $this->dispatchBrowserEvent('openmodalFormAddPhotos');
        } elseif ($action == 'draft') {
            $this->changeDraft();
    ...
    public function changeDraft()
    {
        ...
        return redirect()->to('backend/allalbums');
    }
    ...
    {
        return view('livewire.template.backend.nusantara.album.albumall', [
